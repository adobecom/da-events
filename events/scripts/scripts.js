...
const CONFIG = {
  ...
  locales: {
    ...
    ar: { ietf: 'es-AR', tk: 'hah7vzn.css', base: 'es' },
    ...
    be_nl: { ietf: 'nl-BE', tk: 'qxw8hzm.css', base: 'nl' },
    ...
    cis_en: { ietf: 'en', tk: 'hah7vzn.css', base: '' },
    cl: { ietf: 'es-CL', tk: 'hah7vzn.css', base: 'es' },
    cn: { ietf: 'zh-CN', tk: 'qxw8hzm' },
    co: { ietf: 'es-CO', tk: 'hah7vzn.css', base: 'es' },
    cr: { ietf: 'es-419', tk: 'hah7vzn.css', base: 'es' },
    cy_en: { ietf: 'en-CY', tk: 'hah7vzn.css' },
    cz: { ietf: 'cs-CZ', tk: 'qxw8hzm.css' },
    de: { ietf: 'de-DE', tk: 'hah7vzn.css' },
    dk: { ietf: 'da-DK', tk: 'qxw8hzm.css' },
    ec: { ietf: 'es-419', tk: 'hah7vzn.css', base: 'es' },
    ee: { ietf: 'et-EE', tk: 'qxw8hzm.css' },
    eg_ar: { ietf: 'ar', tk: 'qxw8hzm.css', dir: 'rtl' },
    eg_en: { ietf: 'en-GB', tk: 'hah7vzn.css', base: '' },
    ...
    gt: { ietf: 'es-419', tk: 'hah7vzn.css', base: 'es' },
    ...
    kw_en: { ietf: 'en-GB', tk: 'hah7vzn.css', base: '' },
    ...
    za: { ietf: 'en-GB', tk: 'hah7vzn.css', base: '' },
  },
  adobeid: {
